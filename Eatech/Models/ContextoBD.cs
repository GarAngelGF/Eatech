...
namespace Eatech.Models
{
    public class ContextoBD : DbContext
    {
        ...
        public DbSet<Bd_Escuela> Escuela { get; set; }
        public DbSet<Bd_FotoAlumno> AlumnoFoto { get; set; }
        public DbSet<Bd_FotoComidas> ComidaFoto { get; set; }
        ...
        public DbSet<BdI_Usu_Esc> Intermedia_Usuario_Escuela { get; set; }
